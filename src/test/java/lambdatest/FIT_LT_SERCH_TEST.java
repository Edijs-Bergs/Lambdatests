...
public class FIT_LT_SERCH_TEST {
    ...
    String[] Products = {"MAD MAX", "padengtas svoris", "butelis Ironmax", "Aerobikos viniliniai", " Olimpinis spyruoklinis"};
    char ch = '-';
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "FIT_LT_SERCH_TEST");
