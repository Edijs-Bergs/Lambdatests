...
public class FIT_LV_CATEGORY_SERCH_TEST {
    ...
    String[] Products = {"Sports", "FIZIO", "Kardio", "Sporta uzturs", "Fitness"};
    char ch = '-';
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("name", "FIT_LV_CATEGORY_SERCH_TEST");
    ...
    @Test()
    public void FIT_LV_CATEGORY_SERCH_TEST(){
        try {
            ...
            if (result)
            {
                WebElement Search_Category = driver.findElement(By.xpath("//*/text()[normalize-space(.)='Kategorijas']/parent::*"));
                System.out.println(Search_Category);
                WebElement Search_Product = driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='"+S_Term+"'])[1]/preceding::h2[1]"));
